...
function () {
  ...
  _createClass(Highlight, [{
    ...
    value: function addCustomSelection(key, options) {
      this.customSelections.set(key, (0, _types.createHighlight)(CUSTOM_SELECTION, _objectSpread({}, options)));
    }
    /**
    ...
    value: function value() {
      return [this.cell, this.fill].concat(_toConsumableArray(this.areas.values()), _toConsumableArray(this.headers.values()), _toConsumableArray(this.activeHeaders.values()), _toConsumableArray(this.customSelections.values()))[Symbol.iterator]();
    }
  }]);
