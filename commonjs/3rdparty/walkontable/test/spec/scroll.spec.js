...
describe('WalkontableScroll', function () {
  ...
  describe('scroll', function () {
    ...
    it('scroll viewport to a cell on far bottom and then back should update the border positions', function () {
      spec().$wrapper.width(125).height(201);
      var wt = walkontable({
        data: getData,
        totalRows: getTotalRows,
      ...
      wt.draw();
      var svgPath = spec().$wrapper.find('svg:eq(0) path[stroke-width="2px"]')[0];
