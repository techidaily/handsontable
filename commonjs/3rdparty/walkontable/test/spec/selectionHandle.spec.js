...
describe('WalkontableSelectionHandle', function () {
  var debug = false;
  beforeEach(function () {
  ...
  it('should add/remove corner to selection when cell is clicked', function () {
    ...
    var $corner = $(wt.selections.getCell().getSelectionHandle(wt).corner);
  ...
  it('should draw only one corner if selection is added between overlays', function () {
    ...
    wt.draw();
    var corners = spec().$container.find('.wtBorder.corner:visible');
