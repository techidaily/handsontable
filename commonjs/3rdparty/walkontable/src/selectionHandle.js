...
function () {
   ...
   */
  function SelectionHandle(wotInstance, settings) {
  ...
  _createClass(SelectionHandle, [{
    ...
    key: "createElements",
    value: function createElements(settings) {
      ...
      var holder = wtTable.selectionHandlesHolder;
